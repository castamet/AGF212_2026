...
**seb.ibynb** is a jupyter notebook that contains the surface energy balance calculations from measurement and model data. It also includes the uncertainty calculations for the energy fluxes.
